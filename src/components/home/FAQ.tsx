...
const faqs = [
  ...
  },
  {
    ...
    answer: "Free: 2 checks a day, shorter responses. Premium: 10 checks a day, detailed answers, plus sections you don't get otherwise – competitor context, 6-12 month outlook, and backup strategies if Plan A doesn't work."
  },
  {
