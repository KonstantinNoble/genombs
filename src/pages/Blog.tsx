  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Read expert insights on entrepreneurship, business strategy, AI-powered tools, and startup growth. Learn from successful founders and discover innovative business solutions."
        />
      </Helmet>
        ...
        <section className="py-16 bg-gradient-to-b from-[hsl(220,35%,96%)] to-background relative overflow-hidden">
          ...
          <div className="container relative mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center space-y-6 animate-fade-in-up">
              ...
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent pb-2">
                Expert Knowledge
              </h1>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto">
              {blogPosts.map((post, index) => (
                <Link key={post.id} to={`/blog/${post.id}`} className="group" style={{ touchAction: "manipulation" }}>
                  <Card
                    className="h-full hover:shadow-glow transition-all duration-500 hover:-translate-y-3 border-border hover:border-secondary/40 overflow-hidden animate-scale-in bg-gradient-to-br from-card to-card/80 backdrop-blur-sm"
