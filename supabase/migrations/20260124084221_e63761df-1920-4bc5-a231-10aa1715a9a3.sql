-- Create a function to get dashboard statistics for a user
-- This is more flexible than a view and works better with RLS
...
BEGIN
  ...
  -- Model usage statistics (count how often each model appears in selected_models array)
  SELECT json_build_object(
