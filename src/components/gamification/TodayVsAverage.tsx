          ...
          <table className="w-full table-fixed">
            <thead>
              <tr className="dashboard-table-header">
                <th className="w-[40%] text-left text-xs font-medium text-muted-foreground/60 uppercase tracking-wider pb-2.5 pt-1 pl-4">Category</th>
                <th className="w-[20%] text-right text-xs font-medium text-muted-foreground/60 uppercase tracking-wider pb-2.5 pt-1">Today</th>
                <th className="w-[20%] text-right text-xs font-medium text-muted-foreground/60 uppercase tracking-wider pb-2.5 pt-1">Average</th>
                <th className="w-[20%] text-right text-xs font-medium text-muted-foreground/60 uppercase tracking-wider pb-2.5 pt-1 pr-4">Delta</th>
              </tr>
            </thead>
            <tbody>
              {CATEGORIES.map((cat, i) => {
                ...
                return (
                  ...
                  >
                    <td className="text-left text-sm text-muted-foreground py-2.5 pl-4">{cat.label}</td>
                    ...
                    <td className="text-right text-sm py-2.5 pr-4 whitespace-nowrap">
