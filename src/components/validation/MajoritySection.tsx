          ...
          {points.map((point, index) => (
            ...
            >
              <div className="flex items-center justify-between gap-2 mb-2">
                ...
                <span className="text-base font-medium text-blue-600 bg-blue-500/20 px-2.5 py-1 rounded-full">
                  {point.confidence}%
                </span>
              </div>
              ...
              {point.supportingModels && point.supportingModels.length > 0 && (
                <div className="mt-3 flex flex-wrap gap-2 items-center">
                  ...
                  {point.supportingModels.map((model, i) => (
                    <span
                      key={i}
                      className="text-base font-medium bg-blue-500/20 text-blue-600 px-2.5 py-1 rounded"
                    >
                      {model}
                    </span>
                  ))}
