    ...
    <section className="py-20 sm:py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div ref={headerRef} className={`text-center max-w-3xl mx-auto mb-16 scroll-reveal ${headerVisible ? 'revealed' : ''}`}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">The Difference Documentation Makes</h2>
          <p className="text-lg text-muted-foreground">Compare decisions made in isolation vs. decisions with a documented process</p>
        </div>
