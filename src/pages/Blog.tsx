...
const Blog = () => {
  useEffect(() => {
    document.title = "Business & Entrepreneurship Blog - Expert Insights | Wealthconomy";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Read expert insights on entrepreneurship, business strategy, AI-powered tools, and startup growth. Learn from successful founders and discover innovative business solutions.",
      );
    }
  }, []);
